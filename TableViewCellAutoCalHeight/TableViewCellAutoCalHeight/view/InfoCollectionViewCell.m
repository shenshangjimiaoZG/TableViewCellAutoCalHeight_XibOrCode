...
-(void)setDesc:(NSString *)desc
{
    ...
    NSAttributedString *string = [[NSAttributedString alloc]initWithString:desc attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16], NSParagraphStyleAttributeName:style}];
